...
**Description:** [Provide a brief reason for this choice, e.g. set-up,  accuracy, software, parameters.]
...
|**CODE-GeoCamCal-SENSOR.xml**| Camera Intrinsics | Interior orientation parameters for each sensor, in Agisoft-ready .xml format. |
